package com.its.econtract.services.communication.mobile;
...
import com.its.econtract.services.communication.ECAbstractTSAClient;
...
@Setter
@Getter
public class EMobileTSAClient extends ECAbstractTSAClient implements ITSAClient, TSAClient {
    ...
    public EMobileTSAClient(String apiKey, String secretKey) {
        this.apiKey = apiKey;
